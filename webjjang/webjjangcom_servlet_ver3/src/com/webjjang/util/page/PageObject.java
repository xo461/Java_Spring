...
public class PageObject {
	...
	// 하단부분의 페이지 링크부분(페이지네이션)에 나타날 페이지의 갯수 - perGroupPageNum
	private int perGroupPageNum;
	// 페이지 그룹에 나타나는 처음과 끝 페이지 - 현재 페이지에 따라 다르게 설정된다.
	// total page가 나오면 계산할 수 있다. - totalPage가 25이면 endPage가 30으로 셋팅되는 경우 
...
//	}
	...
	// 전체페이지가 구해지면 리스트 화면 하단 부분 페이지 네이션에 시작페이지와 끝페이지를 계산할 수 있다.
