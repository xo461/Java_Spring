	...
	$(function() {
		$(".dataRow").click(function() {
			...
			${(!empty pageObject.word)?
			   ...
			   += pageObject.word += "\"":""};
			${(!empty pageObject.gradeNoType)?
			   "+ \"&gradeNoType=" += pageObject.gradeNoType
			    += "\"":""};
			${(!empty pageObject.orderType)?
...
<%-- 				<input name="gradeNoType" value="${pageObject.gradeNoType }" type="hidden"/> --%>
<%-- 				<input name="orderType" value="${pageObject.orderType }" type="hidden"/> --%>
				...
				<div class="form-group">
					<select class="form-control" id="gradeNoType" name="gradeNoType">
						<option value="a" ${(param.gradeNoType == "a")?"selected='selected'":"" }>전체</option>
						<option value="b" ${(param.gradeNoType == "b")?"selected='selected'":"" }>전문분석가</option>
					</select>
				</div>
				<div class="form-group">
