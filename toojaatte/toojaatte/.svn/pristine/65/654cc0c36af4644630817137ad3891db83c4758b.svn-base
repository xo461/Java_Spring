	...
	$.ajax({
		...
		success: function(data){
			...
			//----------------------
                ...
                a += '<p><i id="thumbsup" class="'+thumbsup+'" style=\'font-size:26px\' onclick="increaseLike('+value.rno+')">'+value.like_cnt+'</i> '
                a += '<i id="thumbsdown" class="'+thumbsdown+'" style=\'font-size:26px\' onclick="increaseDislike('+value.rno+')">'+value.dislike_cnt+'</i></p>'
