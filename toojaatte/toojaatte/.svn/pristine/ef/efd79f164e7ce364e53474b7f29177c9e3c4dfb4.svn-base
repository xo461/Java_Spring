...
// 			alert("clickRorN")
// 			if(${rornType}!=null && ${rornType}!=""){
// 				rornType = ${rornType}};
// 			alert("rornService.clickRorN().rornType:" + rornType);
			var writer = "${login.id}";
			var no = ${dto.no};
			//데이터 확인
...
<body>
	...
	<div class="container">
		...
		<div style="line-height:30px; vertical-align:middle; width:100%; height:30px; border-top: 1px solid #ddd;">
			<div style="width:200px; float:left"><span style="display:inline-block; width:50px">작성자</span>&nbsp;<span style="display:inline-block; width:5px">|</span>&nbsp;<span name="id">${dto.writer }</span></div>
